...
//
result_e T_MovePlane(sector_t* sector, const fixed_t speed, const fixed_t dest, const boolean crush,
                     const int floorOrCeiling, const int direction)
{
    boolean flag;
    fixed_t lastpos;
...
// HANDLE FLOOR TYPES
//
int EV_DoFloor(const line_t* line, const floor_e floortype)
{
    int i;
...
// BUILD A STAIRCASE!
//
int EV_BuildStairs(const line_t* line, const stair_e type)
{
    int ok;

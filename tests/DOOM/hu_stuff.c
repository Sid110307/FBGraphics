...
char* chat_macros[10] = {
    HUSTR_CHATMACRO0, HUSTR_CHATMACRO1, HUSTR_CHATMACRO2, HUSTR_CHATMACRO3, HUSTR_CHATMACRO4, HUSTR_CHATMACRO5,
    HUSTR_CHATMACRO6, HUSTR_CHATMACRO7, HUSTR_CHATMACRO8, HUSTR_CHATMACRO9
};
...
char* mapnames_commercial[] = {
    ...
    HUSTR_1, HUSTR_2, HUSTR_3, HUSTR_4, HUSTR_5, HUSTR_6, HUSTR_7, HUSTR_8, HUSTR_9, HUSTR_10, HUSTR_11, HUSTR_12,
    HUSTR_13, HUSTR_14, HUSTR_15, HUSTR_16, HUSTR_17, HUSTR_18, HUSTR_19, HUSTR_20, HUSTR_21, HUSTR_22, HUSTR_23,
    HUSTR_24, HUSTR_25, HUSTR_26, HUSTR_27, HUSTR_28, HUSTR_29, HUSTR_30, HUSTR_31, HUSTR_32,
    ...
    PHUSTR_22, PHUSTR_23, PHUSTR_24, PHUSTR_25, PHUSTR_26, PHUSTR_27, PHUSTR_28, PHUSTR_29, PHUSTR_30, PHUSTR_31,
    PHUSTR_32,
    ...
    THUSTR_22, THUSTR_23, THUSTR_24, THUSTR_25, THUSTR_26, THUSTR_27, THUSTR_28, THUSTR_29, THUSTR_30, THUSTR_31,
    THUSTR_32
};
...
void HU_Start(void)
{
    ...
    if (gameversion == exe_chex) { s = HU_TITLE_CHEX; }
    ...
    for (int i = 0; i < MAXPLAYERS; i++) HUlib_initIText(&w_inputbuffer[i], 0, 0, 0, 0, &always_off);
                ...
                { const int rc = HUlib_keyInIText(&w_inputbuffer[i], c);
                    if (rc && c == KEY_ENTER)
                    {
                            ...
                            HU_BROADCAST))
                        {
                            ...
                            message_on = true;
                            message_counter = HU_MSGTIMEOUT;
                            if (gamemode == commercial) S_StartSound(0, sfx_radio);
...
void HU_queueChatChar(const char c)
{
    if ((head + 1 & QUEUESIZE - 1) == tail) { plr->message = DEH_String(HUSTR_MSGU); }
    else
    {
        chatchars[head] = c;
...
boolean HU_Responder(const event_t* ev)
{
    ...
    if (ev->data1 == KEY_RSHIFT) { return false; }
        ...
        )
        {
            for (i = 0; i < MAXPLAYERS; i++)
            {
                if (ev->data2 == key_multi_msgplayer[i])
                {
                    ...
                    {
                        num_nobrainers++;
                        if (num_nobrainers < 3) plr->message = DEH_String(HUSTR_TALKTOSELF1);
                        else if (num_nobrainers < 6) plr->message = DEH_String(HUSTR_TALKTOSELF2);
                        else if (num_nobrainers < 9) plr->message = DEH_String(HUSTR_TALKTOSELF3);
                        else if (num_nobrainers < 32) plr->message = DEH_String(HUSTR_TALKTOSELF4);
                        else plr->message = DEH_String(HUSTR_TALKTOSELF5);
                    }
                }
            }
        }

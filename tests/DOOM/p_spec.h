...
// when needed
boolean P_UseSpecialLine(const mobj_t* thing, line_t* line, int side);
...
int EV_DoLockedDoor(line_t* line, vldoor_e type, const mobj_t* thing);
...
void P_InitSlidingDoorFrames(void);void EV_SlidingDoor(line_t * line, mobj_t * thing);
#endif
